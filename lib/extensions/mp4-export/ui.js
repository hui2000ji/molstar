...
export class Mp4EncoderUI extends CollapsableControls {
    ...
    downloadControls() {
        var _a;
        return _jsxs(_Fragment, { children: [_jsx("div", { className: 'msp-control-offset msp-help-text', children: _jsx("div", { className: 'msp-help-description', style: { textAlign: 'center' }, children: "Rendering successful!" }) }), _jsx(Button, { icon: GetAppSvg, onClick: this.save, style: { marginTop: 1 }, children: "Save Animation" }), ((_a = this.state.data) === null || _a === void 0 ? void 0 : _a.pngFrames) && this.state.data.pngFrames.length > 0 && (_jsxs(Button, { icon: GetAppSvg, onClick: this.savePngFrames, style: { marginTop: 1 }, children: ["Save PNG Frames (", this.state.data.pngFrames.length, ")"] })), _jsx(Button, { onClick: () => this.setState({ data: void 0 }), style: { marginTop: 6 }, children: "Clear" })] });
    }
    renderControls() {
        var _a;
        if (this.state.data) {
