...
export var ElementSymbolColorThemeProvider = {
    ...
    ensureCustomProperties: {
        attach: function (ctx, data, prop) {
            if ((prop === null || prop === void 0 ? void 0 : prop.carbonColor.name) === 'antibody-coloring-residue' && AntibodyColoringResidueColorThemeProvider.ensureCustomProperties) {
        ...
        detach: function (data, props) {
            if ((props === null || props === void 0 ? void 0 : props.carbonColor.name) === 'antibody-coloring-residue' && AntibodyColoringResidueColorThemeProvider.ensureCustomProperties) {
