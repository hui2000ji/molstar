...
import { isStructureComponentRef } from './hierarchy-state';
...
var StructureComponentManager = /** @class */ (function (_super) {
    ...
    StructureComponentManager.prototype.tryFindComponent = function (structureOrComponent, selection) {
        var _this = this;
        var structure = isStructureComponentRef(structureOrComponent) ? structureOrComponent.structure : structureOrComponent;
...
(function (StructureComponentManager) {
    ...
    function getAddParams(plugin, params) {
        ...
        var componentGroups = StructureHierarchyManager.getComponentGroups(plugin.managers.structure.hierarchy.current.structures);
        var components = [];
        ...
        return {
            ...
            options: PD.Group({
                label: PD.Text(''),
                parent: PD.Select(void 0, componentOptions, { isHidden: params === null || params === void 0 ? void 0 : params.hideSelection, description: 'Parent component for the new component. If not specified, the new component will be added to the root structure(s).' }),
