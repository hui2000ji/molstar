...
export declare const StructureComponentParams: () => {
    type: PD.Mapped<PD.NamedParams<Script, "script"> | PD.NamedParams<"water" | "ion" | "protein" | "all" | "ligand" | "polymer" | "branched" | "lipid" | "nucleic" | "non-standard" | "coarse", "static"> | PD.NamedParams<Expression, "expression"> | PD.NamedParams<StructureElement.Bundle, "bundle">>;
