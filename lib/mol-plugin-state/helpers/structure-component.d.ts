...
export declare const StructureComponentParams: () => {
    type: PD.Mapped<PD.NamedParams<"polymer" | "water" | "branched" | "ligand" | "ion" | "protein" | "all" | "lipid" | "nucleic" | "non-standard" | "coarse", "static"> | PD.NamedParams<Script, "script"> | PD.NamedParams<Expression, "expression"> | PD.NamedParams<StructureElement.Bundle, "bundle">>;
