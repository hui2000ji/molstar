...
declare const StructureComplexElement: StateTransformer<SO.Molecule.Structure, SO.Molecule.Structure, PD.Normalize<{
    type: "spheres" | "water" | "protein" | "ligand" | "polymer" | "branched" | "nucleic" | "non-standard" | "coarse" | "atomic-sequence" | "atomic-het";
}>>;
...
declare const StructureComponent: StateTransformer<SO.Molecule.Structure, SO.Molecule.Structure, PD.Normalize<{
    type: PD.NamedParams<Script, "script"> | PD.NamedParams<"water" | "ion" | "protein" | "all" | "ligand" | "polymer" | "branched" | "lipid" | "nucleic" | "non-standard" | "coarse", "static"> | PD.NamedParams<Expression, "expression"> | PD.NamedParams<StructureElement.Bundle, "bundle">;
