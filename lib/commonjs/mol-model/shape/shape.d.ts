...
export declare namespace Shape {
    ...
    function createRenderObject<G extends Geometry>(shape: Shape<G>, props: PD.Values<Geometry.Params<G>>): import("../../mol-gl/render-object").GraphicsRenderObject<"text" | "points" | "mesh" | "spheres" | "cylinders" | "lines" | "direct-volume" | "image" | "texture-mesh">;
    interface Loci {
