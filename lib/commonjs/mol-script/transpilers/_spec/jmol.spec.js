...
var keywords_1 = require("../jmol/keywords");
var properties_1 = require("../jmol/properties");
var operators_1 = require("../jmol/operators");
var general = {
    supported: [
        // atom expressions
        '123',
...
describe('jmol general', function () {
...
describe('jmol keywords', function () { return u.testKeywords(keywords_1.keywords, parser_1.transpiler); });
describe('jmol properties', function () { return u.testProperties(properties_1.properties, parser_1.transpiler); });
describe('jmol operators', function () { return u.testOperators(operators_1.operators, parser_1.transpiler); });
