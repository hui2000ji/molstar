...
console.log('reading');
console.time('read');
fs.readFile('C:\\Projects\\mol-star\\molstar\\build\\tests\\test.xtc', function (err, data) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var ret;
    var _a, _b;
    return tslib_1.__generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                console.time('parse');
                return [4 /*yield*/, (0, parser_1.parseXtc)(new Uint8Array(data)).run(function (o) {
