...
(function (Column) {
    ...
    function runMono() {
        ...
        var nativeData = tslib_1.__spreadArray([], data, true);
        var col = db_1.Column.ofArray({ array: data, schema: db_1.Column.Schema.float });
        var lambda = db_1.Column.ofLambda({ value: val, rowCount: data.length, schema: db_1.Column.Schema.float });
        var cnst = db_1.Column.ofConst(10, data.length, db_1.Column.Schema.float);
        suite
