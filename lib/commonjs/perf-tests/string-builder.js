...
(function (Test) {
    ...
    function build(data, chunkSize) {
        var sb = string_builder_1.StringBuilder.create(chunkSize);
    ...
    function run() {
        ...
        suite
            ...
            .add("".concat(N, " str"), function () { return string_builder_1.StringBuilder.getString(build(data, N)); })
            .add("".concat(N, " str ws"), function () { return string_builder_1.StringBuilder.getString(buildWS(data, N)); })
