            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        fs.writeFileSync("".concat(DATA_DIR, "/").concat(id, "_assembly.bcif"), (0, mmcif_1.to_mmCIF)(id, a, true));
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        fs.writeFileSync("".concat(DATA_DIR, "/").concat(id, "_symm.bcif"), (0, mmcif_1.to_mmCIF)(id, a, true));
                        // fs.writeFileSync(`${DATA_DIR}/${id}_assembly.bcif`, to_mmCIF(id, Selection.unionStructure(alas), true));
                        console.log('exported');
                        return [2 /*return*/];
                }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        fs.writeFileSync("".concat(DATA_DIR, "/").concat(id, "_surr.cif"), (0, mmcif_1.to_mmCIF)(id, surr, false));
                        console.log('exported');
                        return [2 /*return*/];
                }
            });
                ...
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        suite
                            ...
                            .add('test q1', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                            return [2 /*return*/, query(q1, structures[0])];
                        }); }); })
                            .add('test q3', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
