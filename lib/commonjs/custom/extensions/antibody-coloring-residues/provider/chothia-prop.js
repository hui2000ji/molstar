...
exports.AntibodyColoringResidueChothiaProvider = exports.AntibodyColoringResidueParams = exports.fromServer = void 0;
...
function fromServer(ctx, model, props) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = (0, util_1.getSequenceArr)(model), seqs = _a[0], entityIdMapIndex = _a[1];
                ...
                case 1:
                    data = (_b.sent()).data;
                    res = (0, util_1.expandEntityToChainArray)(data.list, model, entityIdMapIndex);
...
exports.AntibodyColoringResidueChothiaProvider = custom_model_property_1.CustomModelProperty.createProvider({
