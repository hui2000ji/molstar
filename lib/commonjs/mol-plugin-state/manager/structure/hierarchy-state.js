...
exports.isStructureComponentRef = exports.StructureHierarchy = exports.buildStructureHierarchy = void 0;
...
function StructureComponentRef(cell, structure, component) {
    return { kind: 'structure-component', cell: cell, version: cell.transform.version, structure: structure, component: component, key: componentKey(cell), representations: [] };
}
...
function isStructureComponentRef(obj) {
    var _a;
    return obj &&
        obj.kind === 'structure-component' &&
        objects_1.PluginStateObject.Molecule.Structure.is((_a = obj.cell) === null || _a === void 0 ? void 0 : _a.obj) &&
        typeof obj.version === 'string' &&
        typeof obj.structure === 'object';
}
exports.isStructureComponentRef = isStructureComponentRef;
