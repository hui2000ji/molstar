...
var StructureComponentManager = /** @class */ (function (_super) {
    ...
    StructureComponentManager.prototype.isNonNestedComponent = function (ref) {
        var isComponentTransform = this.plugin.builders.structure.isComponentTransform;
        var parentCell = this.plugin.state.data.cells.get(ref.cell.transform.parent);
        return (isComponentTransform(ref.cell) &&
                        ...
                        return tslib_1.__generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    s = xs_1[_i];
                                    component = void 0;
                                    if (!(params.options.checkExisting && !(0, hierarchy_state_1.isStructureComponentRef)(s))) return [3 /*break*/, 3];
