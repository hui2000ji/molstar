...
var StructureComponentManager = /** @class */ (function (_super) {
    ...
    StructureComponentManager.prototype.focusThis = function (components) {
        this.plugin.managers.camera.focusSpheres(components, function (r) {
            var _a;
            if (r.cell.state.isHidden)
                return;
            return (_a = r.cell.obj) === null || _a === void 0 ? void 0 : _a.data.boundary.sphere;
        });
    ...
    StructureComponentManager.prototype.tryFindComponent = function (structureOrComponent, selection) {
        var _this = this;
        var structure = (0, hierarchy_state_1.isStructureComponentRef)(structureOrComponent) ? structureOrComponent.structure : structureOrComponent;
            ...
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, this.plugin.dataTransaction(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        ...
                        return tslib_1.__generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    xs = params.options.parent ? [params.options.parent] : (structures || this.currentStructures);
                                    if (xs.length === 0)
                                        return [2 /*return*/];
    ...
    StructureComponentManager.prototype.modifyComponent = function (builder, component, by, action) {
        ...
        var parent = component.component ? (_b = component.component.cell.obj) === null || _b === void 0 ? void 0 : _b.data : (_c = component.structure.cell.obj) === null || _c === void 0 ? void 0 : _c.data;
        ...
        if (modified.elementCount === 0) {
            ...
            var params = {
                ...
                nullIfEmpty: true,
                label: (_d = component.cell.obj) === null || _d === void 0 ? void 0 : _d.label
            };
...
(function (StructureComponentManager) {
    ...
    function getAddParams(plugin, params) {
        ...
        var componentGroups = hierarchy_1.StructureHierarchyManager.getComponentGroups(plugin.managers.structure.hierarchy.current.structures);
        var components = [];
        for (var _i = 0, componentGroups_1 = componentGroups; _i < componentGroups_1.length; _i++) {
            var componentGroup = componentGroups_1[_i];
            components.push.apply(components, componentGroup);
        }
        var componentOptions = components.map(function (c) {
            var _a, _b, _c, _d;
            var trajectoryLabel = ((_c = (_b = (_a = c.structure.model) === null || _a === void 0 ? void 0 : _a.trajectory) === null || _b === void 0 ? void 0 : _b.cell.obj) === null || _c === void 0 ? void 0 : _c.label) || '';
            return [c, trajectoryLabel + ' | ' + (((_d = c.cell.obj) === null || _d === void 0 ? void 0 : _d.label) || '')];
        });
        ...
        return {
            ...
            options: param_definition_1.ParamDefinition.Group({
                ...
                parent: param_definition_1.ParamDefinition.Select(void 0, componentOptions, { isHidden: params === null || params === void 0 ? void 0 : params.hideSelection, description: 'Parent component for the new component. If not specified, the new component will be added to the root structure(s).' }),
