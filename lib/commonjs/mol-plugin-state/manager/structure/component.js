...
class StructureComponentManager extends component_1.StatefulPluginComponent {
    ...
    tryFindComponent(structureOrComponent, selection) {
        const structure = (0, hierarchy_state_1.isStructureComponentRef)(structureOrComponent) ? structureOrComponent.structure : structureOrComponent;
    ...
    modifyComponent(builder, component, by, action) {
        ...
        const parent = component.component ? (_b = component.component.cell.obj) === null || _b === void 0 ? void 0 : _b.data : (_c = component.structure.cell.obj) === null || _c === void 0 ? void 0 : _c.data;
...
(function (StructureComponentManager) {
    ...
    function getAddParams(plugin, params) {
        ...
        const componentGroups = hierarchy_1.StructureHierarchyManager.getComponentGroups(plugin.managers.structure.hierarchy.current.structures);
        const components = [];
        ...
        const componentOptions = components.map(c => {
            var _a, _b, _c, _d;
            const trajectoryLabel = ((_c = (_b = (_a = c.structure.model) === null || _a === void 0 ? void 0 : _a.trajectory) === null || _b === void 0 ? void 0 : _b.cell.obj) === null || _c === void 0 ? void 0 : _c.label) || '';
