...
export declare const StructureComponentParams: () => {
    type: PD.Mapped<PD.NamedParams<Script, "script"> | PD.NamedParams<Expression, "expression"> | PD.NamedParams<"water" | "ion" | "protein" | "all" | "polymer" | "branched" | "ligand" | "nucleic" | "lipid" | "non-standard" | "coarse", "static"> | PD.NamedParams<StructureElement.Bundle, "bundle">>;
