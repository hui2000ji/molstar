...
declare const StructureComplexElement: StateTransformer<SO.Molecule.Structure, SO.Molecule.Structure, PD.Normalize<{
    type: "water" | "protein" | "spheres" | "polymer" | "branched" | "ligand" | "nucleic" | "non-standard" | "coarse" | "atomic-sequence" | "atomic-het";
}>>;
...
declare const StructureComponent: StateTransformer<SO.Molecule.Structure, SO.Molecule.Structure, PD.Normalize<{
    type: PD.NamedParams<Script, "script"> | PD.NamedParams<Expression, "expression"> | PD.NamedParams<"water" | "ion" | "protein" | "all" | "polymer" | "branched" | "ligand" | "nucleic" | "lipid" | "non-standard" | "coarse", "static"> | PD.NamedParams<StructureElement.Bundle, "bundle">;
