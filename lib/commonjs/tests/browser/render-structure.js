...
var assetManager = new assets_1.AssetManager();
var canvas3d = canvas3d_1.Canvas3D.create(canvas3d_1.Canvas3DContext.fromCanvas(canvas, assetManager));
canvas3d.animate();
...
function init() {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ctx = { runtime: synchronous_1.SyncRuntimeContext, assetManager: assetManager };
                ...
                case 6:
                    ...
                    return [4 /*yield*/, cartoonRepr.createOrUpdate(tslib_1.__assign(tslib_1.__assign({}, cartoon_1.CartoonRepresentationProvider.defaultValues), { quality: 'auto' }), structure).run()];
                case 7:
                    _a.sent();
                    _a.label = 8;
                case 8:
                    ...
                    return [4 /*yield*/, interactionRepr.createOrUpdate(tslib_1.__assign(tslib_1.__assign({}, interactions_1.InteractionsRepresentationProvider.defaultValues), { quality: 'auto' }), structure).run()];
                case 9:
                    _a.sent();
                    _a.label = 10;
                case 10:
                    ...
                    return [4 /*yield*/, ballAndStickRepr.createOrUpdate(tslib_1.__assign(tslib_1.__assign({}, ball_and_stick_1.BallAndStickRepresentationProvider.defaultValues), { quality: 'auto' }), structure).run()];
                case 11:
                    _a.sent();
                    _a.label = 12;
                case 12:
                    ...
                    return [4 /*yield*/, molecularSurfaceRepr.createOrUpdate(tslib_1.__assign(tslib_1.__assign({}, molecular_surface_1.MolecularSurfaceRepresentationProvider.defaultValues), { quality: 'custom', alpha: 0.5, flatShaded: true, doubleSided: true, resolution: 0.3 }), structure).run()];
                case 13:
                    _a.sent();
                ...
                case 14:
                    ...
                    return [4 /*yield*/, gaussianSurfaceRepr.createOrUpdate(tslib_1.__assign(tslib_1.__assign({}, gaussian_surface_1.GaussianSurfaceRepresentationProvider.defaultValues), { quality: 'custom', alpha: 1.0, flatShaded: true, doubleSided: true, resolution: 0.3 }), structure).run()];
                case 15:
                    _a.sent();
                ...
                case 16:
                    ...
                    return [4 /*yield*/, membraneOrientationRepr.createOrUpdate(tslib_1.__assign(tslib_1.__assign({}, representation_2.MembraneOrientationRepresentationProvider.defaultValues), { quality: 'auto' }), structure).run()];
                case 17:
                    _a.sent();
                    _a.label = 18;
                case 18:
