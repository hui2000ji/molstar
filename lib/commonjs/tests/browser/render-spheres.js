...
function spheresRepr() {
    var spheresBuilder = spheres_builder_1.SpheresBuilder.create(3, 1);
    ...
    var values = spheres_1.Spheres.Utils.createValuesSimple(spheres, {}, (0, color_1.Color)(0xFF0000), 1);
