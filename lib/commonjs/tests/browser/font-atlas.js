...
require("./index.html");
var font_atlas_1 = require("../../mol-geo/geometry/text/font-atlas");
var util_1 = require("../../mol-gl/renderable/util");
function test() {
    console.time('FontAtlas init');
    var fontAtlas = new font_atlas_1.FontAtlas({ fontQuality: 3 });
    ...
    console.log("".concat(Object.keys(fontAtlas.mapped).length, " chars prepared"));
}
test();
