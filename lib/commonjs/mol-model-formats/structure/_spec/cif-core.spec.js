...
describe('cif-core read', function () {
    it('frame', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var parsed, cifFile, block;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, cif_1.CIF.parseText(cifCoreString).run()];
                case 1:
                    parsed = _a.sent();
                    if (parsed.isError)
                        return [2 /*return*/];
    ...
    it('schema', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    cifFile = parsed.result;
                    block = cifFile.blocks[0];
                    cifCore = cif_1.CIF.schema.cifCore(block);
