...
var int_adjacency_graph_1 = require("../int-adjacency-graph");
describe('IntGraph', function () {
    var vc = 3;
    var xs = [0, 1, 2];
    var ys = [1, 2, 0];
    var _prop = [10, 11, 12];
    var builder = new int_adjacency_graph_1.IntAdjacencyGraph.EdgeBuilder(vc, xs, ys);
    ...
    it('induce', function () {
        var induced = int_adjacency_graph_1.IntAdjacencyGraph.induceByVertices(graph, [1, 2]);
