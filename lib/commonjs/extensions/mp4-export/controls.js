...
exports.Mp4AnimationParams = {
    ...
    exportPngFrames: param_definition_1.ParamDefinition.Boolean(false, { description: 'Export each frame as a PNG file' })
};
var Mp4Controls = /** @class */ (function (_super) {
    ...
    Mp4Controls.prototype.render = function () {
        ...
        var task = mol_task_1.Task.create('Export Animation', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var resolution, anim, result, filename, baseFilename, e_1;
            var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, encoder_1.encodeMp4Animation)(this.plugin, ctx, tslib_1.__assign(tslib_1.__assign({ animation: {
                                    ...
                                    params: anim.values,
                                } }, resolution), { quantizationParameter: this.behaviors.params.value.quantization, pass: (_b = this.plugin.helpers.viewportScreenshot) === null || _b === void 0 ? void 0 : _b.imagePass, exportPngFrames: this.behaviors.params.value.exportPngFrames }))];
                    case 1:
                        result = _d.sent();
                        filename = anim.anim.display.name.toLowerCase().replace(/\s/g, '-').replace(/[^a-z0-9_\-]/g, '');
                        baseFilename = "".concat((_c = this.plugin.helpers.viewportScreenshot) === null || _c === void 0 ? void 0 : _c.getFilename(''), "_").concat(filename);
                        return [2 /*return*/, {
                                movie: result.movie,
                                filename: "".concat(baseFilename, ".mp4"),
