    ...
    render() {
        const task = mol_task_1.Task.create('Export Animation', async (ctx) => {
            ...
            try {
                ...
                const result = await (0, encoder_1.encodeMp4Animation)(this.plugin, ctx, {
                    animation: {
                ...
                const baseFilename = `${(_c = this.plugin.helpers.viewportScreenshot) === null || _c === void 0 ? void 0 : _c.getFilename('')}_${filename}`;
                return {
                    movie: result.movie,
