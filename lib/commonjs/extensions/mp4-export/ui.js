...
var Mp4EncoderUI = /** @class */ (function (_super) {
    ...
    function Mp4EncoderUI() {
        ...
        _this.savePngFrames = function () {
            var _a;
            if (!((_a = _this.state.data) === null || _a === void 0 ? void 0 : _a.pngFrames) || !_this.state.data.pngFilenamePrefix)
                return;
            var zip = new jszip_1.default();
            _this.state.data.pngFrames.forEach(function (frame, index) {
                // Use padded frame numbering (e.g., 001, 002, etc.)
                var paddedIndex = String(index).padStart(String(_this.state.data.pngFrames.length).length, '0');
                zip.file("".concat(_this.state.data.pngFilenamePrefix, "_frame").concat(paddedIndex, ".png"), frame);
            });
            zip.generateAsync({ type: 'blob' }).then(function (blob) {
                (0, download_1.download)(blob, "".concat(_this.state.data.pngFilenamePrefix, "_frames.zip"));
            });
        };
    ...
    Mp4EncoderUI.prototype.downloadControls = function () {
        var _this = this;
        var _a;
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { className: 'msp-control-offset msp-help-text', children: (0, jsx_runtime_1.jsx)("div", { className: 'msp-help-description', style: { textAlign: 'center' }, children: "Rendering successful!" }) }), (0, jsx_runtime_1.jsx)(common_1.Button, { icon: icons_1.GetAppSvg, onClick: this.save, style: { marginTop: 1 }, children: "Save Animation" }), ((_a = this.state.data) === null || _a === void 0 ? void 0 : _a.pngFrames) && this.state.data.pngFrames.length > 0 && ((0, jsx_runtime_1.jsxs)(common_1.Button, { icon: icons_1.GetAppSvg, onClick: this.savePngFrames, style: { marginTop: 1 }, children: ["Save PNG Frames (", this.state.data.pngFrames.length, ")"] })), (0, jsx_runtime_1.jsx)(common_1.Button, { onClick: function () { return _this.setState({ data: void 0 }); }, style: { marginTop: 6 }, children: "Clear" })] });
    };
    Mp4EncoderUI.prototype.renderControls = function () {
        ...
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(parameters_1.ParameterControls, { params: ctrl.behaviors.animations.value, values: { current: current === null || current === void 0 ? void 0 : current.anim.name }, onChangeValues: function (xs) { return ctrl.setCurrent(xs.current); }, isDisabled: this.state.busy }), current && (0, jsx_runtime_1.jsx)(parameters_1.ParameterControls, { params: current.params, values: current.values, onChangeValues: function (xs) { return ctrl.setCurrentParams(xs); }, isDisabled: this.state.busy }), (0, jsx_runtime_1.jsx)("div", { className: 'msp-control-offset msp-help-text', children: (0, jsx_runtime_1.jsxs)("div", { className: 'msp-help-description', style: { textAlign: 'center' }, children: ["Resolution: ", info.width, "x", info.height, (0, jsx_runtime_1.jsx)("br", {}), "Adjust in viewport using ", (0, jsx_runtime_1.jsx)(icons_1.Icon, { svg: icons_1.CameraOutlinedSvg, inline: true })] }) }), (0, jsx_runtime_1.jsx)(parameters_1.ParameterControls, { params: controls_1.Mp4AnimationParams, values: ctrl.behaviors.params.value, onChangeValues: function (xs) { return ctrl.behaviors.params.next(xs); }, isDisabled: this.state.busy }), (0, jsx_runtime_1.jsx)(common_1.Button, { onClick: this.generate, style: { marginTop: 1 }, disabled: this.state.busy || !canApply.canApply, commit: canApply.canApply ? 'on' : 'off', children: canApply.canApply ? 'Render' : (_a = canApply.reason) !== null && _a !== void 0 ? _a : 'Invalid params/state' })] });
    };
