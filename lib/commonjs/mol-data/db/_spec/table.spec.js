...
describe('string column', function () {
    ...
    var arr = column_1.Column.ofArray({ array: xs, schema: column_1.Column.Schema.str });
    var arrLC = column_1.Column.ofArray({ array: xs, schema: column_1.Column.Schema.Str({ transform: 'lowercase' }) });
    var aliasedLC = column_1.Column.ofArray({ array: xs, schema: column_1.Column.Schema.Aliased(column_1.Column.Schema.lstr) });
    it('value', function () {
        var _a, _b;
