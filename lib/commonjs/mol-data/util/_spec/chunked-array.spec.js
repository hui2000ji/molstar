...
var chunked_array_1 = require("../chunked-array");
describe('Chunked Array', function () {
    it('creation', function () {
        var arr = chunked_array_1.ChunkedArray.create(Array, 2, 2);
    ...
    it('initial', function () {
        var arr = chunked_array_1.ChunkedArray.create(Int32Array, 2, 6, new Int32Array([1, 2, 3, 4]));
    ...
    it('resize', function () {
        var arr = chunked_array_1.ChunkedArray.create(Int32Array, 2, 2);
        chunked_array_1.ChunkedArray.add2(arr, 1, 2);
        chunked_array_1.ChunkedArray.add2(arr, 3, 4);
        chunked_array_1.ChunkedArray.add2(arr, 5, 6);
    ...
    it('resize-fraction', function () {
        var arr = chunked_array_1.ChunkedArray.create(Int32Array, 2, 2.5);
        chunked_array_1.ChunkedArray.add2(arr, 1, 2);
        chunked_array_1.ChunkedArray.add2(arr, 3, 4);
        chunked_array_1.ChunkedArray.add2(arr, 5, 6);
        chunked_array_1.ChunkedArray.add2(arr, 7, 8);
