...
describe('basic iterators', function () {
    ...
    check('map', iterator_1.Iterator.map(iterator_1.Iterator.Range(0, 1), function (x) { return x + 1; }), [1, 2]);
    check('filter', iterator_1.Iterator.filter(iterator_1.Iterator.Range(0, 3), function (x) { return x >= 2; }), [2, 3]);
});
