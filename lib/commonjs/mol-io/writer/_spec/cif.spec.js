...
var Data = tslib_1.__importStar(require("../../reader/cif/data-model"));
var cif_1 = require("../cif");
var decode_1 = require("../../common/msgpack/decode");
var field_1 = require("../../reader/cif/binary/field");
var text_1 = require("../cif/encoder/text");
var C = tslib_1.__importStar(require("../cif/encoder"));
var db_1 = require("../../../mol-data/db");
var parser_1 = require("../../reader/cif/text/parser");
...
var encoding_aware_encoder = cif_1.CifWriter.createEncoder({
    binary: true,
    binaryAutoClassifyEncoding: true,
    binaryEncodingPovider: cif_1.CifWriter.createEncodingProviderFromJsonConfig([
        {
...
test('cif writer value escaping', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                values = ['1', ' ', '  ', " ' ", "a'", "b\"", "\"", '  a  ', "\"'\"", "'\"", "\na"];
                table = db_1.Table.ofArrays({ values: db_1.Column.Schema.str }, { values: values });
                encoder = new text_1.TextEncoder();
                C.Encoder.writeDatabase(encoder, 'test', db_1.Database.ofTables('test', { test: table._schema }, { test: table }));
                encoder.encode();
                data = encoder.getData();
                return [4 /*yield*/, (0, parser_1.parseCifText)(data).run()];
            case 1:
                result = _b.sent();
                if (result.isError) {
...
var filter_aware_encoder1 = cif_1.CifWriter.createEncoder({
    binary: true,
    binaryAutoClassifyEncoding: true
});
filter_aware_encoder1.setFilter(C.Category.filterOf('atom_site\n' +
    ...
    'atom_site.Cartn_x\n' +
    'atom_site.Cartn_y\n'));
var filter_aware_encoder2 = cif_1.CifWriter.createEncoder({
    binary: true
});
...
function process(encoder) {
    ...
    var unpacked = (0, decode_1.decodeMsgPack)(encoded);
...
function getCategoryInstanceProvider(cat, fields) {
    return {
        name: cat.name,
        instance: function () { return cif_1.CifWriter.categoryInstance(fields, { data: cat, rowCount: cat.rowCount }); }
    };
}
