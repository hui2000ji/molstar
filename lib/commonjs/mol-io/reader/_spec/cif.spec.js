...
var Data = tslib_1.__importStar(require("../cif/data-model"));
var Schema = tslib_1.__importStar(require("../cif/schema"));
...
(function (TestSchema) {
    TestSchema.test = {
        ...
        strList: db_1.Column.Schema.List(',', function (x) { return x; }),
        intList: db_1.Column.Schema.List(' ', function (x) { return parseInt(x, 10); })
    };
    TestSchema.schema = { test: TestSchema.test };
})(TestSchema || (TestSchema = {}));
test('cif triple quote', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var data, result, cat;
