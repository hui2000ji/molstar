...
describe('gro reader', function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    groFile = parsed.result;
                    data = groFile.structures[0];
                    header = data.header, atoms = data.atoms;
    ...
    it('high precision', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var parsed, groFile, data, header, atoms;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, parser_1.parseGRO)(groStringHighPrecision).run()];
                case 1:
                    parsed = _a.sent();
                    if (parsed.isError) {
                        console.log(parsed);
