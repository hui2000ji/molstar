...
(function (Theme) {
    ...
    async function ensureDependencies(ctx, theme, data, props) {
        var _a, _b;
        await ((_a = theme.colorThemeRegistry.get(props.colorTheme.name).ensureCustomProperties) === null || _a === void 0 ? void 0 : _a.attach(ctx, data, props.colorTheme.params));
        await ((_b = theme.sizeThemeRegistry.get(props.sizeTheme.name).ensureCustomProperties) === null || _b === void 0 ? void 0 : _b.attach(ctx, data, props.sizeTheme.params));
    }
