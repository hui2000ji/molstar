...
export declare const CartoonColorThemeParams: {
    ...
    sidechain: PD.Mapped<PD.NamedParams<PD.Normalize<{
        ...
        carbonColor: PD.NamedParams<PD.Normalize<{
            ...
            palette: /*elided*/ any;
        }>, "unit-index"> | PD.NamedParams<PD.Normalize<unknown>, "element-symbol"> | PD.NamedParams<PD.Normalize<{
            'CDR def.': /*elided*/ any;
            'VH/V\u03B1 FR': /*elided*/ any;
            'VL/V\u03B2 FR': /*elided*/ any;
            'VH/V\u03B1 CDR': /*elided*/ any;
            'VL/V\u03B2 CDR': /*elided*/ any;
            'Other polymer': /*elided*/ any;
            'Non-polymer': /*elided*/ any;
        }>, "antibody-coloring-residue"> | PD.NamedParams<PD.Normalize<{
            palette: /*elided*/ any;
        }>, "trajectory-index">;
        saturation: number;
        lightness: number;
