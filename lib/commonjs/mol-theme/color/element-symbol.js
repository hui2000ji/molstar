...
exports.ElementSymbolColorThemeParams = {
    carbonColor: param_definition_1.ParamDefinition.MappedStatic('chain-id', {
        ...
        'antibody/TCR': param_definition_1.ParamDefinition.Group(color_3.AntibodyColoringResidueColorThemeParams),
...
function getCarbonTheme(ctx, props) {
    switch (props.name) {
        ...
        case 'antibody/TCR': return (0, color_3.AntibodyColoringResidueColorTheme)(ctx, props.params);
