...
var unit_index_1 = require("./unit-index");
var uniform_1 = require("./uniform");
var color_3 = require("../../custom/extensions/antibody-coloring-residues/color");
...
exports.ElementSymbolColorThemeParams = {
    carbonColor: param_definition_1.ParamDefinition.MappedStatic('antibody-coloring-residue', {
        ...
        'antibody-coloring-residue': param_definition_1.ParamDefinition.Group(color_3.AntibodyColoringResidueColorThemeParams, { label: 'Antibody/TCR' }),
...
function getCarbonTheme(ctx, props) {
    switch (props.name) {
        ...
        case 'antibody-coloring-residue': return (0, color_3.AntibodyColoringResidueColorTheme)(ctx, props.params);
...
function ElementSymbolColorTheme(ctx, props) {
    ...
    var carbonColor = (_a = getCarbonTheme(ctx, props.carbonColor)) === null || _a === void 0 ? void 0 : _a.color;
    ...
    var granularity = (props.carbonColor.name === 'operator-name' || props.carbonColor.name === 'unit-index') ? 'groupInstance' : 'group';
    return {
...
exports.ElementSymbolColorThemeProvider = {
    ...
    ensureCustomProperties: {
        attach: function (ctx, data, prop) {
            if ((prop === null || prop === void 0 ? void 0 : prop.carbonColor.name) === 'antibody-coloring-residue' && color_3.AntibodyColoringResidueColorThemeProvider.ensureCustomProperties) {
                return color_3.AntibodyColoringResidueColorThemeProvider.ensureCustomProperties.attach(ctx, data, prop.carbonColor.params);
            }
            else {
                return Promise.resolve();
            }
        },
        detach: function (data, props) {
            if ((props === null || props === void 0 ? void 0 : props.carbonColor.name) === 'antibody-coloring-residue' && color_3.AntibodyColoringResidueColorThemeProvider.ensureCustomProperties) {
                color_3.AntibodyColoringResidueColorThemeProvider.ensureCustomProperties.detach(data, props.carbonColor.params);
            }
        }
    }
};
