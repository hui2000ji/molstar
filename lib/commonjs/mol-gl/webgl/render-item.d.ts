...
export declare function getDrawMode(ctx: WebGLContext, drawMode: DrawMode): 0 | 2 | 1 | 3 | 4 | 5 | 6;
...
export declare const GraphicsRenderVariants: ("colorBlended" | "colorWboit" | "colorDpoit" | "pick" | "depth" | "marking")[];
export declare const GraphicsRenderVariantsBlended: ("colorBlended" | "colorWboit" | "colorDpoit" | "pick" | "depth" | "marking")[];
export declare const GraphicsRenderVariantsWboit: ("colorBlended" | "colorWboit" | "colorDpoit" | "pick" | "depth" | "marking")[];
export declare const GraphicsRenderVariantsDpoit: ("colorBlended" | "colorWboit" | "colorDpoit" | "pick" | "depth" | "marking")[];
...
export declare function createGraphicsRenderItem(ctx: WebGLContext, drawMode: DrawMode, shaderCode: ShaderCode, schema: RenderableSchema, values: RenderableValues, materialId: number, variants: GraphicsRenderVariant[]): RenderItem<"colorBlended" | "colorWboit" | "colorDpoit" | "pick" | "depth" | "marking">;
