...
function createImage() {
    var image = image_1.Image.createEmpty();
    var props = param_definition_1.ParamDefinition.getDefaultValues(image_1.Image.Params);
    var values = image_1.Image.Utils.createValuesSimple(image, props, names_1.ColorNames.orange, 1);
