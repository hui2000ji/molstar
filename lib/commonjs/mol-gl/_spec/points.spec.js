...
function createPoints() {
    var points = points_1.Points.createEmpty();
    var props = param_definition_1.ParamDefinition.getDefaultValues(points_1.Points.Params);
    var values = points_1.Points.Utils.createValuesSimple(points, props, names_1.ColorNames.orange, 1);
    var state = points_1.Points.Utils.createRenderableState(props);
