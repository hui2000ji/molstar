...
function createTextureMesh() {
    var textureMesh = texture_mesh_1.TextureMesh.createEmpty();
    var props = param_definition_1.ParamDefinition.getDefaultValues(texture_mesh_1.TextureMesh.Params);
    var values = texture_mesh_1.TextureMesh.Utils.createValuesSimple(textureMesh, props, names_1.ColorNames.orange, 1);
    var state = texture_mesh_1.TextureMesh.Utils.createRenderableState(props);
