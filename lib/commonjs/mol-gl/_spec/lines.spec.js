...
function createLines() {
    var lines = lines_1.Lines.createEmpty();
    var props = param_definition_1.ParamDefinition.getDefaultValues(lines_1.Lines.Params);
    var values = lines_1.Lines.Utils.createValuesSimple(lines, props, names_1.ColorNames.orange, 1);
