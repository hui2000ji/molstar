...
function createGl(width, height, contextAttributes) {
    ...
    return {
        ...
        getShaderSource: function (shader) { return ''; },
        getTexParameter: function () { },
        getUniform: function () { },
        getVertexAttrib: function () { },
        getVertexAttribOffset: function (index, pname) { return 0; },
        hint: function (target, mode) { },
        isBuffer: function (buffer) { return true; },
        isEnabled: function (cap) { return true; },
        isFramebuffer: function (framebuffer) { return true; },
        isProgram: function (program) { return true; },
        isRenderbuffer: function (renderbuffer) { return true; },
        isShader: function (shader) { return true; },
        isTexture: function (texture) { return true; },
        getExtension: function (extensionName) {
            switch (extensionName) {
                ...
                case 'WEBGL_debug_shaders': return {
                    getTranslatedShaderSource(shader) { return ''; }
                };
