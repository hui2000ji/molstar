...
declare namespace Loci {
    ...
    export const GranularityOptions: ["model" | "residue" | "entity" | "chain" | "element" | "structure" | "operator" | "elementInstances" | "residueInstances" | "chainInstances", string][];
    /** Exclude `Instances` granularity kinds */
    export function simpleGranularity(granularity: Granularity): "model" | "residue" | "entity" | "chain" | "element" | "structure" | "operator" | "elementInstances" | "residueInstances" | "chainInstances";
