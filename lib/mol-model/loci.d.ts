...
declare namespace Loci {
    ...
    export const GranularityOptions: ["model" | "entity" | "residue" | "structure" | "element" | "chain" | "operator" | "elementInstances" | "residueInstances" | "chainInstances", string][];
    /** Exclude `Instances` granularity kinds */
    export function simpleGranularity(granularity: Granularity): "model" | "entity" | "residue" | "structure" | "element" | "chain" | "operator" | "elementInstances" | "residueInstances" | "chainInstances";
