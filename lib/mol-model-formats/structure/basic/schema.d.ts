...
export declare const BasicSchema: {
    ...
    entity: {
        ...
        type: import("../../../mol-data/db/column").Column.Schema.Aliased<"water" | "non-polymer" | "polymer" | "macrolide" | "branched">;
