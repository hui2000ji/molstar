...
export const AntibodyColoringResidue = PluginBehavior.create({
    ...
    ctor: class extends PluginBehavior.Handler {
        constructor() {
            super(...arguments);
            this.kabatProvider = AntibodyColoringResidueKabatProvider;
            this.chothiaProvider = AntibodyColoringResidueChothiaProvider;
            this.imgtProvider = AntibodyColoringResidueImgtProvider;
            this.northProvider = AntibodyColoringResidueNorthProvider;
        }
        register() {
